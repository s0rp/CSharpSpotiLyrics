...
Revised: Native-Aot Compatible Class
*/
...
namespace CSharpSpotiLyrics.Core.Models
{
    ...
    public class AlbumUnionObject
    {
        ...
        public SharingInfoObject? SharingInfo { get; set; }
    }
    ...
    public class ContextObject
    {
        ...
        [JsonPropertyName("external_urls")] public Dictionary<string, string>? ExternalUrls { get; set; } = new();
    ...
    public class SpotifyTrack
    {
        ...
        public Dictionary<string, string>? ExternalUrls { get; set; } = new(); // Init to avoid null ref
